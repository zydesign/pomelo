...
//这个是服务器创建应用使用的主要app工厂函数，调用app.init（）创建一个应用类
 ...
 * 在配置文件 servers.json中通过serverId获取服务器信息
 * @param  {String} serverId server id
 * @return {Object} server info or undefined
 * @memberOf Application
 */
